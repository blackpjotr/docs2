...
hide_title: true
description: Strategies for archive node redundancy, backup, and data recovery.
keywords:
...
O1Labs publishes nightly dumps of its public-network archives to the [mina-archive-dumps](https://console.cloud.google.com/storage/browser/mina-archive-dumps) GCS bucket as a convenience:
