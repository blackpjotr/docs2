...
```
    docker run -it --rm --name rosetta \
        ...
        -p 10101:10101 -p 3085:3085 -p 127.0.0.1:3086:3086 -p 3087:3087 \
...
```
    ...
    MINA_GENESIS_LEDGER_URL=https://storage.googleapis.com/o1labs-gitops-infrastructure/mainnet/mainnet.json
...
- The archive server runs on port 3086. It has no authentication, so the commands above publish it on 127.0.0.1 only. Do not expose it to the internet
