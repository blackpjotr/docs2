...
See: [Worked example using March 22 data](/network-upgrades/berkeley/archive-migration/debian-example)

### Example migration steps using Mina Foundation data for Mainnet using Docker

See: [Worked example using March 22 data](/network-upgrades/berkeley/archive-migration/docker-example)
