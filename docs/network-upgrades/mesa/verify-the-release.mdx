...
# Mainnet: mina-create-mainnet-prefork-genesis-ledger=3.5.0-mainnet-stop-slot-8110ede
# Devnet: mina-create-devnet-prefork-genesis-ledger=3.5.0-devnet-stop-slot-7a60364
sudo apt-get install mina-create-<network>-prefork-genesis-ledger=<prefork-version>
```
