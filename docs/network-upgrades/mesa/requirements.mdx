...
hide_title: true
description: Hardware and connectivity requirements for daemon node operators upgrading to Mesa — block producers, SNARK coordinators, archive nodes, Rosetta API nodes, and seed nodes.
keywords:
  - Mesa
  - upgrade
