...
Docker images are available for both `amd64` and `arm64` architectures, and for the `bookworm`, `noble`, `focal`, and `jammy` base distributions. Replace `<codename>` with the distribution that matches your host:

- **Mina Daemon:** `gcr.io/o1labs-192920/mina-daemon:4.0.0-preflight-stop-2967b39-<codename>-mesa`
- **Archive Node:** `gcr.io/o1labs-192920/mina-archive:4.0.0-preflight-stop-2967b39-<codename>-mesa`
- **Rosetta:** `gcr.io/o1labs-192920/mina-rosetta:4.0.0-preflight-stop-2967b39-<codename>-mesa`
...
**Channel:** `preflight`
**Codenames:** `bookworm`, `noble`, `focal`, `jammy`
