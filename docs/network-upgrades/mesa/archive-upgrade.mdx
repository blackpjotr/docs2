...
The Mesa Trail archive version is **`4.0.0-rc2-3418329`**. Docker tag: `minaprotocol/mina-archive:4.0.0-rc2-3418329-bullseye-devnet`. See [Mesa Trail Network](./mesa-trail) for the full release matrix.
