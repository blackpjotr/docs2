---
title: 'Tutorial 11: Anonymous Message Board'
hide_title: true
sidebar_label: 'Tutorial 11: Anonymous Message Board'
...
# Tutorial 11: Anonymous Message Board
...
1. Change to the project directory:
  ...
  Each time you make updates, then build or deploy, the TypeScript code is compiled into JavaScript in the `build` directory. See the included [README](https://github.com/o1-labs/docs2/blob/main/examples/zkapps/11-anonymous-message-board/README.md) file with usage instructions.
...
1. Copy the entire contents of the [message.ts](https://github.com/o1-labs/docs2/blob/main/examples/zkapps/11-anonymous-message-board/src/message.ts) example file into your local `message-board/src/message.ts` file.
...
```sh
cd examples/zkapps/11-anonymous-message-board
npm install
npm start
```
