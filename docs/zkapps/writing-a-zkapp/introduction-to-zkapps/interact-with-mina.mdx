...
In general, there are three kinds of authorizations that an account update can have: a proof, a signature, or none. You learn more about signatures in the next section. You can find more details in [Permissions](https://docs.o1labs.org/o1js/zkapps/permissions).
...
You can learn more about testing in [Test zkApps Locally](https://docs.o1labs.org/o1js/zkapps/local-development).
